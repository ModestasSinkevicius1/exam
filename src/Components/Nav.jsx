    ...
    return (       
        <nav>
            <div className="nav-control">
                ...
                {status === 2 || status === 3 ? <NavLink to="/home/create" className={ ({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Create Fund</NavLink>                  : null}
                {status === 3 ? <NavLink to="/admin/funds" className={ ({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Funds</NavLink> : null}
            </div>
